...
from Scripts.Utils import show_ai_popup
...
class MainWindow_Ui(QtCore.QObject):
    ...
    def check_update(self):
        ...
        try:
            ...
            if update.have_new_version(new_version):
                self.add_message_signal.emit(
                    f"最新版本地址：https://github.com/Fish-Ring/RainClassroomAssistantAiVersion/releases/latest",
                    0,
                )
                if is_debug():
    ...
    def show_config(self):
        ...
        if dialog.exec_():
            ...
            # 重新初始化AI客户端
            init_ai_client(self.config)
            self.add_message_signal.emit("AI配置已更新", 0)
